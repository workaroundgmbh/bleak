        ...
        if self._services_resolved:
            ...
            for service in services_result.Services:
                ...
                for characteristic in characteristics_result.Characteristics:
                    ...
                    self.services.add_characteristic(BleakGATTCharacteristicDotNet(characteristic))
                    ...
                    for descriptor in list(descriptors_result.Descriptors):
                        self.services.add_descriptor(BleakGATTDescriptorDotNet(descriptor, characteristic.Uuid.ToString()))
